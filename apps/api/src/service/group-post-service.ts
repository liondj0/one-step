...
export const createGroupPost = async (params: CreateGroupPostDto) => {
...
export const addReaction = async (params: AddReactionDto) => {
  ...
  reaction.reactionsGroup = RequestContext.getEntityManager()!.getReference(
    ReactionsGroupEntity,
    params.reactionGroupId,
  );
