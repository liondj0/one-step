...
import {Cascade, Entity, Enum, ManyToOne, type Rel, Unique} from "@mikro-orm/core";
...
export class UserInGroupEntity extends BaseEntity {
  ...
  @ManyToOne({entity: () => UserEntity, fieldName: 'userId', cascade: [Cascade.PERSIST, Cascade.MERGE, Cascade.REMOVE]})
  user!: Rel<UserEntity>;

  @ManyToOne({entity: () => GroupEntity, fieldName: 'groupId', cascade: [Cascade.PERSIST, Cascade.MERGE, Cascade.REMOVE]})
