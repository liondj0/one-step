      ...
      >
        <View className={`px-6 pt-6 pb-10 flex flex-col flex-1`}>
          <View className={`flex flex-row items-center mb-8`}>
            ...
            <View className={`ml-4`}>
              <Text className={`text-xl font-medium text-forest`}>
                New Post
              </Text>
            ...
            <Pressable
              ...
              className={`rounded-3xl bg-forest flex flex-row px-6 py-1 ml-auto ${message.length > 10 ? "" : "opacity-50"}`}
            >
              <MaterialCommunityIcons
                name={"send"}
                size={20}
          ...
          <View
            className={`bg-white flex-1 shadow-2xl shadow-black rounded-2xl py-8 px-6 flex`}
          >
            ...
            <TextInput
              ...
              className={`w-full h-52 placeholder:text-dustysky text-forest text-lg`}
              multiline={true}
              placeholder={`How was your step today? Share your progress, challenges, or victories...`}
            />
            <View className={`flex flex-row justify-end`}>
              <Text className={`text-sm text-dustysky`}>
                {message.length}/500
              </Text>
            </View>
          </View>
