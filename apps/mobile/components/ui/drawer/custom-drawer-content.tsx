    ...
    >
      <View className={`flex flex-1 mb-4`}>
        <View className={`ml-4 flex flex-row items-center`}>
          <View
            className={`h-12 w-12 rounded-full bg-sunbeam/30 flex items-center justify-center`}
          >
          ...
          <Pressable onPress={() => go("/")}>
            <View className={`flex flex-row mb-8 items-center`}>
              ...
              <View>
                ...
                <Text className={`text-forest/50 text-md`}>
                  Track your progress
                </Text>
              </View>
            </View>
          ...
          <Pressable onPress={signOut}>
            <View className={`flex flex-row mb-8 items-center`}>
              ...
              <View>
                ...
                <Text className={`text-danger/50 text-md`}>
